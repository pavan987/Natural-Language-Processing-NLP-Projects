...
class TestSequenceFunctions(unittest.TestCase):
    ...
    def test_rhyme(self):
        ...
        try: self.assertEqual(self.ld.rhymes("ark", "ink"), False)
        except: s.append(17)
...
And found it was perfectly true"""
        ...
        try: self.assertEqual(self.ld.is_limerick(p), False)
        except: s.append('p')
        try: self.assertEqual(self.ld.is_limerick(t), False)
        except: s.append('t')
        try: self.assertEqual(self.ld.is_limerick(u), True)
        except: s.append('u')
        try: self.assertEqual(self.ld.is_limerick(ab), False)
        except: s.append('ab')
        try: self.assertEqual(self.ld.is_limerick(ac), False)
        except: s.append('ac')
        try: self.assertEqual(self.ld.is_limerick(ad), False)
        except: s.append('ad')
        try: self.assertEqual(self.ld.is_limerick(ae), False)
        except: s.append('ae')
        try: self.assertEqual(self.ld.is_limerick(af), False)
        except: s.append('af')
        try: self.assertEqual(self.ld.is_limerick(ag), False)
        except: s.append('ag')
